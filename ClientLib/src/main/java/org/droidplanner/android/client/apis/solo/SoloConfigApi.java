...
import static org.droidplanner.services.android.lib.drone.companion.solo.action.SoloConfigActions.ACTION_REFRESH_SOLO_VERSIONS;
import static org.droidplanner.services.android.lib.drone.companion.solo.action.SoloConfigActions.ACTION_UPDATE_BUTTON_SETTINGS;
import static org.droidplanner.services.android.lib.drone.companion.solo.action.SoloConfigActions.ACTION_UPDATE_CONTROLLER_MODE;
import static org.droidplanner.services.android.lib.drone.companion.solo.action.SoloConfigActions.ACTION_UPDATE_CONTROLLER_UNIT;
import static org.droidplanner.services.android.lib.drone.companion.solo.action.SoloConfigActions.ACTION_UPDATE_TX_POWER_COMPLIANCE_COUNTRY;
import static org.droidplanner.services.android.lib.drone.companion.solo.action.SoloConfigActions.ACTION_UPDATE_WIFI_SETTINGS;
import static org.droidplanner.services.android.lib.drone.companion.solo.action.SoloConfigActions.EXTRA_BUTTON_SETTINGS;
import static org.droidplanner.services.android.lib.drone.companion.solo.action.SoloConfigActions.EXTRA_CONTROLLER_MODE;
import static org.droidplanner.services.android.lib.drone.companion.solo.action.SoloConfigActions.EXTRA_CONTROLLER_UNIT;
import static org.droidplanner.services.android.lib.drone.companion.solo.action.SoloConfigActions.EXTRA_TX_POWER_COMPLIANT_COUNTRY_CODE;
import static org.droidplanner.services.android.lib.drone.companion.solo.action.SoloConfigActions.EXTRA_WIFI_PASSWORD;
import static org.droidplanner.services.android.lib.drone.companion.solo.action.SoloConfigActions.EXTRA_WIFI_SSID;
...
public class SoloConfigApi extends SoloApi {
     ...
     *
     * @param controllerMode Controller mode. @see {@link org.droidplanner.services.android.lib.drone.companion.solo.controller.SoloControllerMode.ControllerMode}
     * @param listener       Register a callback to receive update of the command execution status.
     */
     ...
     * @param controllerUnit Controller unit system. @see {@link org.droidplanner.services.android.lib.drone.companion.solo.controller.SoloControllerUnits.ControllerUnit}
