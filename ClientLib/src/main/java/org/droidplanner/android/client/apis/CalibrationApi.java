...
import static org.droidplanner.services.android.lib.gcs.action.CalibrationActions.ACTION_ACCEPT_MAGNETOMETER_CALIBRATION;
import static org.droidplanner.services.android.lib.gcs.action.CalibrationActions.ACTION_CANCEL_MAGNETOMETER_CALIBRATION;
import static org.droidplanner.services.android.lib.gcs.action.CalibrationActions.ACTION_SEND_IMU_CALIBRATION_ACK;
import static org.droidplanner.services.android.lib.gcs.action.CalibrationActions.ACTION_START_IMU_CALIBRATION;
import static org.droidplanner.services.android.lib.gcs.action.CalibrationActions.ACTION_START_MAGNETOMETER_CALIBRATION;
import static org.droidplanner.services.android.lib.gcs.action.CalibrationActions.EXTRA_IMU_STEP;
import static org.droidplanner.services.android.lib.gcs.action.CalibrationActions.EXTRA_RETRY_ON_FAILURE;
import static org.droidplanner.services.android.lib.gcs.action.CalibrationActions.EXTRA_SAVE_AUTOMATICALLY;
import static org.droidplanner.services.android.lib.gcs.action.CalibrationActions.EXTRA_START_DELAY;
