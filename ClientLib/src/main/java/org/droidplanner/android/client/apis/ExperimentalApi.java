...
import static org.droidplanner.services.android.lib.drone.action.CameraActions.EXTRA_VIDEO_TAG;
import static org.droidplanner.services.android.lib.drone.action.ExperimentalActions.ACTION_SEND_MAVLINK_MESSAGE;
import static org.droidplanner.services.android.lib.drone.action.ExperimentalActions.ACTION_SET_RELAY;
import static org.droidplanner.services.android.lib.drone.action.ExperimentalActions.ACTION_SET_ROI;
import static org.droidplanner.services.android.lib.drone.action.ExperimentalActions.ACTION_SET_SERVO;
import static org.droidplanner.services.android.lib.drone.action.ExperimentalActions.ACTION_TRIGGER_CAMERA;
import static org.droidplanner.services.android.lib.drone.action.ExperimentalActions.EXTRA_IS_RELAY_ON;
import static org.droidplanner.services.android.lib.drone.action.ExperimentalActions.EXTRA_MAVLINK_MESSAGE;
import static org.droidplanner.services.android.lib.drone.action.ExperimentalActions.EXTRA_RELAY_NUMBER;
import static org.droidplanner.services.android.lib.drone.action.ExperimentalActions.EXTRA_SERVO_CHANNEL;
import static org.droidplanner.services.android.lib.drone.action.ExperimentalActions.EXTRA_SERVO_PWM;
import static org.droidplanner.services.android.lib.drone.action.ExperimentalActions.EXTRA_SET_ROI_LAT_LONG_ALT;
