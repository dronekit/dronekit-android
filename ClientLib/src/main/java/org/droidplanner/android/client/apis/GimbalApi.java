...
import static org.droidplanner.services.android.lib.drone.action.GimbalActions.*;
...
public final class GimbalApi extends Api implements DroneListener {
    ...
    public interface GimbalOrientationListener {
         ...
         * @param error @see {@link org.droidplanner.services.android.lib.drone.attribute.error.CommandExecutionError}
         */
