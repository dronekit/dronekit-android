package org.droidplanner.android.client.apis;
...
import static org.droidplanner.services.android.lib.drone.action.ControlActions.ACTION_DO_GUIDED_TAKEOFF;
import static org.droidplanner.services.android.lib.drone.action.ControlActions.ACTION_ENABLE_MANUAL_CONTROL;
import static org.droidplanner.services.android.lib.drone.action.ControlActions.ACTION_LOOK_AT_TARGET;
import static org.droidplanner.services.android.lib.drone.action.ControlActions.ACTION_SEND_BRAKE_VEHICLE;
import static org.droidplanner.services.android.lib.drone.action.ControlActions.ACTION_SEND_GUIDED_POINT;
import static org.droidplanner.services.android.lib.drone.action.ControlActions.ACTION_SET_CONDITION_YAW;
import static org.droidplanner.services.android.lib.drone.action.ControlActions.ACTION_SET_GUIDED_ALTITUDE;
import static org.droidplanner.services.android.lib.drone.action.ControlActions.ACTION_SET_VELOCITY;
import static org.droidplanner.services.android.lib.drone.action.ControlActions.EXTRA_ALTITUDE;
import static org.droidplanner.services.android.lib.drone.action.ControlActions.EXTRA_DO_ENABLE;
import static org.droidplanner.services.android.lib.drone.action.ControlActions.EXTRA_FORCE_GUIDED_POINT;
import static org.droidplanner.services.android.lib.drone.action.ControlActions.EXTRA_GUIDED_POINT;
import static org.droidplanner.services.android.lib.drone.action.ControlActions.EXTRA_LOOK_AT_TARGET;
import static org.droidplanner.services.android.lib.drone.action.ControlActions.EXTRA_VELOCITY_X;
import static org.droidplanner.services.android.lib.drone.action.ControlActions.EXTRA_VELOCITY_Y;
import static org.droidplanner.services.android.lib.drone.action.ControlActions.EXTRA_VELOCITY_Z;
import static org.droidplanner.services.android.lib.drone.action.ControlActions.EXTRA_YAW_CHANGE_RATE;
import static org.droidplanner.services.android.lib.drone.action.ControlActions.EXTRA_YAW_IS_RELATIVE;
import static org.droidplanner.services.android.lib.drone.action.ControlActions.EXTRA_YAW_TARGET_ANGLE;
