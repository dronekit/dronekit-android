package org.droidplanner.android.client.utils.geotag;

import android.os.AsyncTask;

import org.droidplanner.android.client.utils.data.tlog.TLogParser;
...
public abstract class GeoTagAsyncTask extends AsyncTask<Void, Integer, GeoTagUtils.ResultObject> {
     ...
     * @param events   {@link List< org.droidplanner.android.client.utils.data.tlog.TLogParser.Event>} list of events to geotag photos.
