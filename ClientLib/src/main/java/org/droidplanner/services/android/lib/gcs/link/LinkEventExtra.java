...
public class LinkEventExtra {
    ...
    private static final String PACKAGE_NAME = "org.droidplanner.services.android.lib.gcs.link.event.extra";

    /**
     * Used to access the link connection status.
     *
     * @see {@link LinkConnectionStatus}
     * @see {@link org.droidplanner.services.android.lib.gcs.link.LinkEvent#LINK_STATE_UPDATED}
     */
