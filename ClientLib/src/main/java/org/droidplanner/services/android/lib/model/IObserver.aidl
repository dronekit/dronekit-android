...
oneway interface IObserver {
    ...
    * @param attributeEvent event describing the update. The supported events are listed in {@link org.droidplanner.services.android.lib.drone.attribute.AttributeEvent}
