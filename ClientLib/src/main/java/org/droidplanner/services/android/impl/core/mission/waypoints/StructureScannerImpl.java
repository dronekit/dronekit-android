...
public class StructureScannerImpl extends SpatialCoordItem {
    ...
    private void packHatch(List<msg_mission_item> list) {
        ...
        try {
            survey.update(0.0, survey.getAltitude(), survey.getOverlap(), survey.getSidelap(), survey.getLockOrientation(), false, 0);
            ...
            survey.update(90.0, survey.getAltitude(), survey.getOverlap(), survey.getSidelap(), survey.getLockOrientation(), false, 0);
