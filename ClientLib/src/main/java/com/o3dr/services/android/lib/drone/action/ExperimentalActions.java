...
public class ExperimentalActions {
    ...
    public static final String EXTRA_SET_ROI_LAT = "extra_set_roi_lat";
    public static final String EXTRA_SET_ROI_LONG = "extra_set_roi_long";
    public static final String EXTRA_SET_ROI_ALT = "extra_set_roi_alt";
