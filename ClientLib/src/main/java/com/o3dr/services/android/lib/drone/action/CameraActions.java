...
public class CameraActions {
    ...
    public static final String ACTION_START_VIDEO_STREAM_FOR_OBSERVER = PACKAGE_NAME + ".START_VIDEO_STREAM_FOR_OBSERVER";
    ...
    public static final String ACTION_STOP_VIDEO_STREAM_FOR_OBSERVER = PACKAGE_NAME + ".STOP_VIDEO_STREAM_FOR_OBSERVER";
}
