...
public enum ApmCommands {	
	...
	CMD_NAV_DO_LAND_START("Do Land Start",MAV_CMD.MAV_CMD_DO_LAND_START,CommandType.NAVIGATION), /* Mission command to prepare for a landing.  |Empty| Empty| Empty| Empty| Latitude| Longitude| Altitude|  */
